...
LIMIT 1  ";
    ...
    public function get_status($id)
    {
        $sql =
            ...
            WHERE req.req_emp_id=$id AND req.req_status < 5 AND req.req_form_count <= 4 AND req.req_edit_count <= 3 AND req.req_reject_count <= 3 AND CURDATE() <= req.req_end_date 
            LIMIT 0,30  ";
        $query = $this->db->query($sql);
        return $query;
    }
