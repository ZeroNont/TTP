...
<body>
    <div class="card">
        <div class="card-header" id="card_radius">
                ...
                <div class="container">
                    ...
                    <div class="card">
                        ...
                        <span><img src=<?php echo base_url() ?>assets/img/Logo.jfif width="150" height="150">
                            <img src=<?php echo base_url() ?>assets/img/HR.png width="150" height="150"
                                align="right"></span>
                        <div class="card-body ">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="End_date" class="form-control" required
                                                    value="<?php if ($obj_form[0]->req_emp_id == $obj_dep[0]->Emp_ID) {
            ...
            <center><a id="hid" href="<?php echo site_url() . 'Check_status/Check_status/home'; ?>"
                    class="btn btn-secondary float-center"><i class="fas fa-arrow-alt-circle-left"></i> Back</a>
            </center>
