                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($obj_status[$i]->req_status <= 0) { ?>
                                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal<?php echo $i; ?>">
                                ...
                                <?php } else if ($obj_status[$i]->req_status == 4) { ?>
                                    ...
                                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal2<?php echo $i; ?>">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="<?php echo site_url() . 'Check_out_form/Check_out_form/check_out/' . $obj_status[$i]->req_form_id; ?> " method="post" enctype="multipart/form-data">
