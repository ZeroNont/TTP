        ...
        <div class="table-responsive">
            <table class="table align-items-center" id="history_table">
                ...
                <tbody class="list">
                    ...
                    <?php for ($i = 0; $i < count($sp_form); $i++){?>
                    <tr>
                        <td class="text-center">
                            <?php echo ($i + 1); ?> </td>
                        </td>
                        <td>
                            <?php echo $sp_form[$i]->Form_ID ?></td>
                        </td>
                        <td>
                            <?php echo $sp_form[$i]->Item ?></td>
                        </td>
                        <td>
                        <?php echo $sp_form[$i]->Start_date." - ".$sp_form[$i]->End_date ?></td>
                        </td>
                        <td>
                            <?php echo $sp_form[$i]->Officer ?></td>
                        </td>
                    </tr>
                    <?php }?>
                </tbody>
