                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="Start_date" class="form-control" required
                                value="<?php echo $arr_form->req_start_date ?>" disabled>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="End_date" class="form-control" required
                                value="<?php echo $arr_form->req_end_date ?>" disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="Item" class="form-control" require
                                value="<?php echo $arr_form->req_item ?>" disabled>
                        </div>
                    </div>
                    <div class=" col-lg-12 ">
                        <div class=" form-group">
                            ...
                            <input type="text" name="Reason" class="form-control" require
                                value="<?php echo $arr_form->req_reason ?>" disabled>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="Officer" require
                                value="<?php echo $arr_emp[0]->Empname_eng . " " . $arr_emp[0]->Empsurname_eng; ?>"
                                disabled>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="Tell" require
                                value="<?php echo $arr_form->req_tel ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-control-label" for="input-country">Layout
                                (รูปแบบการวาง)</label>
                            <br>
                            <a href="<?php echo base_url()?>assets/file/layout/<?php echo $arr_file[0]->fil_layout_location ?>"
                                download>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-control-label" for="input-country">Plan
                                (แผนการวาง)</label>
                            <br>
                            <a href="<?php echo base_url()?>assets/file/Plan/<?php echo $arr_file[0]->fil_plan_location ?>"
                                download>
                                <button type="button" class="btn btn-danger" id="button_size">
                                    <i class="fas fa-file-alt text-dark"></i>
                                    &nbsp;&nbsp;File
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $arr_ver[$i]->his_edit_version ?></td>
...
<a href="<?php echo base_url().'history/History/show_history_employee/'.$_SESSION['UsEmp_ID']?>">
    <center><button type="button" class="btn btn-secondary btn-lg canter" id='button_UPsize'><i
                class="fas fa-arrow-alt-circle-left"></i>Back</button> </center>
</a>
<br>