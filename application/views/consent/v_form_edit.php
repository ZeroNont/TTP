                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="Start_date" class="form-control" min="<?php echo date('Y-m-d'); ?>" required value="<?php echo $obj_form[0]->req_start_date ?>">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="End_date" class="form-control" min="<?php echo date('Y-m-d'); ?>" required value="<?php echo $obj_form[0]->req_end_date ?>">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="Item" class="form-control" required value="<?php echo $obj_form[0]->req_item ?>">
                                <input type="text" name="form" class="form-control" required value="<?php echo $obj_form[0]->req_form_id ?>" hidden>
                                <input type="text" name="count" class="form-control" required value="<?php echo $obj_form[0]->req_form_count ?>" hidden>
                            </div>
                        </div>
                        <div class=" col-lg-12 ">
                            <div class=" form-group">
                                ...
                                <input type="text" name="Reason" class="form-control" required value="<?php echo $obj_form[0]->req_reason ?>">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="form-control-label" for="input-city">Tel No.
                                    (เบอร์โทรศัพท์)</label>
                                <input type="text" class="form-control" name="Tell" requiredd value="<?php echo $obj_form[0]->req_tel ?>">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-control-label" for="input-country">Layout
                                    (รูปแบบการวาง)</label>
                                <input type="file" name="Layout" class="form-control" value="<?php echo $obj_file[0]->fil_layout_location ?>">
                                <a href="<?php echo base_url() ?>assets/file/layout/<?php echo $obj_file[0]->fil_layout_location ?>" download>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-control-label" for="input-country">Plan
                                    (แผนการวาง)</label>
                                <input type="file" name="Plan" class="form-control" value="<?php echo $obj_file[0]->fil_plan_location ?>">
                                <a href="<?php echo base_url() ?>assets/file/plan/<?php echo $obj_file[0]->fil_plan_location ?>" download>
                                    <button type="button" class="btn btn-danger" id="button_size">
                                        <i class="fas fa-file-alt text-dark"></i>
                                        &nbsp;&nbsp;Plan
                                    </button>
