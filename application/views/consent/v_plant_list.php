...
<div class="card-header" id="card_radius">
    <h1>
        Plant Management (การจัดการข้อมูล Approve Plant)
                ...
                <div class="modal-body">
                    <form action="<?php echo site_url() . 'Plant_management/Plant_input/insert'; ?>" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="Emp_ID" id="Emp_id_modal"
                                placeholder="JS000xxx" onkeyup="get_Emp()" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-dot mr-4">
                                ...
                                <span class="status">out of process</span>
