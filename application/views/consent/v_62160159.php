...
.bg {
    /* The image used */
    background-image: url("https://www.teahub.io/photos/full/40-407628_244-pastel-hd-wallpapers-data-src-pastel-wallpaper.jpg");
    /* Full height */
    height: 100%;
...
<body class="bg">
    <div class="card p-5 my-5 mr-5 ml-5">
        <!-------------------------------------------------------------- start form ----------------------------------------------------------->
        <form action="#">
            <div class="card-header">
                <h1 style="text-align: center; font-family: 'Prompt', sans-serif;">แบบสอบถามข้อมูลส่วนบุคคล</h1>
            </div>
            <!----- card header ----->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4 mb-3">
                            ...
                            <input id="input" type="text" class="form-control mt-1" name="fname" placeholder="ชื่อ"
                                required>
                        </div>
                        <!----- col ชื่อ ----->
                        <div class="form-group col-md-6 mb-3">
                            <label id="label">นามสกุล :</label>
                            <input type="text" class="form-control mt-1" id="input" name="lname" placeholder="นามสกุล"
                                required>
                        </div>
                        <!----- col นามสกุล ----->
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <input id="input" type="date" class="form-control mt-1" name="birthday"
                                placeholder="วันเกิด" required>
                        </div>
                        <!----- col วันเกิด ----->
                        <div class="form-group col-md-4 mb-3">
                            <label id="label">รหัสนิสิต : </label>
                            <input id="input" type="number" class="form-control mt-1" name="stuid"
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <input id="input" type="email" class="form-control mt-1" name="email"
                                placeholder="example@email.com" required>
                        </div>
                        <!----- col อีเมล ----->
                        <div class="form-group col-md-6 mb-3">
                            <label id="label">รหัสผ่าน :</label>
                            <input id="input" type="password" class="form-control mt-1" name="pass"
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select id="input" class="form-control mt-1" name="infor" disabled>
                        ...
                        <div class="form-group col-md-4 mb-3">
                            ...
                            <input id="input" class="form-control mt-1" type="number" size="8" value="3" name="stuyear"
                                disabled>
                        </div>
                        <!----- col นิสิตชั้นปีที่ ----->
                    </div>
