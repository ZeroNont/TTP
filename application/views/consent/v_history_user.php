        ...
        <div class="table-responsive">
            <table class="table align-items-center" id="history_table">
                ...
                <tbody class="list">
                    ...
                    <?php for ($i = 0; $i < count($arr_form); $i++){?>
                    <tr>
                        <td class="text-center">
                            <?php echo ($i + 1); ?> </td>
                        </td>
                        <td>
                            <?php echo $arr_form[$i]->Form_ID ?></td>
                        </td>
                        <td>
                            <?php echo $arr_form[$i]->Item ?></td>
                        </td>
                        <td>
                        <?php echo $arr_form[$i]->Start_date." - ".$arr_form[$i]->End_date ?></td>
                        </td>
                        <td>
                            <?php echo $arr_form[$i]->Officer ?></td>
                        </td>
                    </tr>
                    <?php }?>
                </tbody>
