        ...
        <div class="scrollbar-inner">
            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <br>
                     <!-- Divider -->
                     <span class="fas fa-user-circle text-dark" class="docs-normal" id="menu_divider">&nbsp;&nbsp; Approve Plant</span>
            ...
            <div class="table-responsive">
                <table class="table align-items-center" id="history_table">
                    <thead class="thead-light">
                        ...
                        <tbody class="list">
                            <?php for ($i = 0; $i < count($ap_form); $i++){?>
                                <tr>
                                    <td class="text-center">
                                        <?php echo ($i + 1); ?> </td>
                                    </td>
                                    <td>
                                        <?php echo $ap_form[$i]->Form_ID ?></td>
                                    </td>
                                    <td>
                                        <?php echo $ap_form[$i]->Item ?></td>
                                    </td>
                                    <td>
                                    <?php echo $ap_form[$i]->Start_date." - ".$ap_form[$i]->End_date ?></td>
                                    </td>
                                    <td>
                                        <?php echo $ap_form[$i]->Officer ?></td>
                                    </td>
                                </tr>
                            <?php }?>
                        </tbody> 
